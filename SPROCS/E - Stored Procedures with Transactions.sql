...
GO
CREATE OR ALTER PROCEDURE TransferCourse
    -- Parameters here
    @StudentID      int,
    @Semester       char(5),
...
GO
CREATE OR ALTER PROCEDURE AdjustMarks
    -- Parameters here
    @CourseID   char(7)
AS
    -- Body of procedure here
...
GO
CREATE OR ALTER PROCEDURE WitnessProtection
    @StudentID  int,
    @First      varchar(25),
    @Last       varchar(35),
    @Gender     char(1),
...
GO
CREATE OR ALTER PROCEDURE StudentPayment
    @StudentID      int,
    @PaymentAmount  money,
...
CREATE OR ALTER PROCEDURE WithdrawStudent
    @StudentID  int,
    @CourseID   char(7),
    @Semester   char(5)
AS
...
CREATE OR ALTER PROCEDURE ArchiveStudentGrades
    @RecordYear char(4)
AS
